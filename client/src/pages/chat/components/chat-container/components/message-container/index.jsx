...
import { GET_ALL_MESSAGES, GET_CHANNEL_MESSAGES } from '@/utils/constants';
      ...
      <div className={`mt-5 ${message.sender._id !== userInfo.id ? "text-left":"text-right"} `}>
        ...
        }
        {
          message.sender._id !== userInfo.id ? (
           <div className={`flex items-center ${message.sender._id !== userInfo.id ? "justify-start":"justify-end"} gap-3`}>
