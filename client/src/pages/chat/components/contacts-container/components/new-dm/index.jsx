           ...
           text-small hover:text-neutral-100 cursor-pointer transition-all duration-300"
            ...
            <Dialog open={openNewContactModal} onOpenChange={() => {
                ...
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                    ...
                    <div>
                        <Input onChange={e => searchContacts(e.target.value)} placeholder="Search Contacts"
                               className="rounded-lg p-6 border-none bg-[#1c1b1e]"/>
                    </div>
                    {
                                ...
                                <div className="flex flex-col gap-5">
                                    {searchedContacts.map((contact) => {
                                        return (
                                            ...
                                            <div onClick={() => selectNewContact(contact)} key={contact._id}
                                                    ...
                                                    <Avatar className="h-12 w-12 rounded-full overflow-hidden">
                                                        {
                                                            contact.image ?
                                                                ...
                                                                /> : <div
                                                                    className={`uppercase h-12 w-12  text-lg border-[3px] flex items-center justify-center rounded-full ${getColor(contact.color)}`}>
            ...
            {contact.firstName && contact.lastName ? `${contact.firstName} ${contact.lastName}` : contact.email}
                    ...
                    }
                    {
                        ...
                        (
                            <div
                                className="flex-1  md:flex mt-5 md:mt-0 flex-col justify-center items-center duration-1000 transition-all">
                                <Lottie
